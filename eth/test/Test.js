...
(function() {
  var BetokenFund, BetokenProxy, BigNumber, CO, CPD, CompoundOrder, DAI, DAI_PRICE, DAY, ETH_ADDR, ETH_PRICE, FUND, INACTIVE_THRESHOLD, KAIRO_PRICE, KN, KRO, LONG_LEVERAGE, MAX_NEW_MANAGERS_PER_CYCLE, MiniMeToken, MiniMeTokenFactory, NEW_MANAGER_KAIRO, OMG_PRICE, PEAK_PRECISION, PHASE_LENGTHS, PRECISION, PeakReward, PeakStaking, SHORT_LEVERAGE, ST, TK, TestCERC20, TestCERC20Factory, TestCEther, TestComptroller, TestKyberNetwork, TestPriceOracle, TestToken, TestTokenFactory, ZERO_ADDR, bnToString, calcRegisterPayAmount, epsilon, epsilon_equal, getReceiveKairoRatio, timeTravel;
