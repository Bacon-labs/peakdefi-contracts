...
(function() {
  var BetokenFund, BetokenLogic, BetokenLogic2, BetokenLogic3, BetokenProxy, BigNumber, CompoundOrderFactory, ETH_ADDR, LongCERC20Order, LongCEtherOrder, MiniMeToken, MiniMeTokenFactory, PRECISION, PeakReward, PeakStaking, ShortCERC20Order, ShortCEtherOrder, ZERO_ADDR, bnToString;
  ...
  module.exports = async function() {
    var BetokenLogic2Contract, BetokenLogic3Contract, BetokenLogicContract, BetokenProxyContract, CompoundOrderFactoryContract, ControlToken, LongCERC20OrderContract, LongCEtherOrderContract, PeakReferralToken, PeakRewardContract, PeakStakingContract, PeakToken, ShareToken, ShortCERC20OrderContract, ShortCEtherOrderContract, TestCERC20, TestCERC20Factory, TestCEther, TestCEtherContract, TestComptroller, TestComptrollerContract, TestDAI, TestKyberNetwork, TestKyberNetworkContract, TestPriceOracle, TestPriceOracleContract, TestToken, TestTokenFactory, accounts, betokenFund, compoundTokenAddrs, compoundTokens, compoundTokensArray, config, controlTokenAddr, i, j, k, l, len, len1, len2, len3, m, minimeFactory, peakReferralTokenAddr, peakTokenAddr, ref, ref1, ref2, shareTokenAddr, testCERC20Factory, testDAIAddr, testTokenFactory, token, tokenAddrs, tokenObj, tokenPrices, tokensInfo;
    ...
    await betokenFund.initInternalTokens(ControlToken.address, ShareToken.address, PeakReferralToken.address);
    await betokenFund.init(accounts[0], config.phaseLengths, bnToString(config.devFundingRate), ZERO_ADDR, TestDAI.address, TestKyberNetworkContract.address, CompoundOrderFactoryContract.address, BetokenLogicContract.address, BetokenLogic2Contract.address, BetokenLogic3Contract.address, 1, ZERO_ADDR, PeakRewardContract.address);
