...
(function() {
  var BetokenFactory, BetokenFund, BetokenLogic, BetokenLogic2, BetokenLogic3, BetokenProxy, BigNumber, CompoundOrderFactory, ETH_ADDR, LongCERC20Order, LongCEtherOrder, MiniMeToken, MiniMeTokenFactory, PRECISION, PeakReward, PeakStaking, ShortCERC20Order, ShortCEtherOrder, ZERO_ADDR, bnToString;
  ...
  module.exports = async function() {
    ...
    betokenFactory = (await BetokenFactory.new(TestDAI.address, TestKyberNetworkContract.address, ZERO_ADDR, fundTemplate.address, BetokenLogicContract.address, BetokenLogic2Contract.address, BetokenLogic3Contract.address, PeakRewardContract.address, minimeFactory.address));
